...
export const env = {
  ...
  REFRESH_TOKEN_EXPIRES: getEnv("REFRESH_TOKEN_EXPIRES", false) || "1h",
  // Customer JWT secrets (Phase 2)
  CUSTOMER_JWT_ACCESS_SECRET: getEnv("CUSTOMER_JWT_ACCESS_SECRET", false),
  CUSTOMER_JWT_REFRESH_SECRET: getEnv("CUSTOMER_JWT_REFRESH_SECRET", false),
